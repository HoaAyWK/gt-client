...
const createShadow = (isDark = false) => {
  const color = isDark ? DARK_MODE : LIGHT_MODE;
...
const createCustomShadow = (isDark) => {
  const color = isDark ? DARK_MODE : LIGHT_MODE;
...
export const customShadows = (isDark) => createCustomShadow(isDark);

const shadows = (isDark) => createShadow(isDark);
